  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[placeholder]:text-muted-foreground focus-visible:ring-2 focus-visible:ring-ring/50 focus-visible:border-ring",
        "disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive [&_svg]:size-4 [&_svg]:shrink-0",
        className,
      )}
      {...props}
    >
